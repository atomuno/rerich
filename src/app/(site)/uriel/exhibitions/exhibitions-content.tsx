...
import type { UrielExhibitionView } from "@/lib/cms/payload-queries";

export default function ExhibitionsContent({
  exhibitions,
}: {
  exhibitions: UrielExhibitionView[];
}) {
  const [selectedEx, setSelectedEx] = useState<UrielExhibitionView | null>(
    null,
  );
