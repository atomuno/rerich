          ...
          <div className="prose prose-slate max-w-none font-sans text-slate-700 leading-relaxed">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <p>
                  ...
                  : иллюминаторы, штурвалы, письменный стол, конторка,
            ...
            <div className="mt-10 pt-10 border-t border-slate-100 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="mb-4">
                  В музее можно увидеть в действии:пелорус с магнитным компасом,
                  сигнальный фонарь, электрический тифон, телеграф и судовой
                  колокол. Представленные детали и штормтрап изготовлены детьми
                  и их руководителями по всем правилам морского дела.
                </p>
                <p>
