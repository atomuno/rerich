...
export const metadata: Metadata = {
  ...
  description:
    "Официальный портал Севастопольского фонда Рерихов и Центра детского творчества «Уриэль». Культурно-просветительская деятельность и наследие семьи Рерихов.",
